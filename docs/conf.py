...
description = 'A New Module of PyIRI for IRTAM Coefficients'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
version = pkg_resources.get_distribution('PyIRTAM').version
...
# documentation.
html_logo = os.path.join(os.path.abspath('.'), 'figures', 'PyIRTAM_logo.png')
